...
export default function StopPopup({ stop, index, onRemove, onNoteChange, onClose }) {
  return (
    <div className="p-3 w-[min(220px,72vw)]">
      ...
      {onRemove && (
        <button
          onClick={() => { onRemove(stop.id); onClose?.() }}
...
export function POIPopup({ poi, onAddAsStop, onClose }) {
